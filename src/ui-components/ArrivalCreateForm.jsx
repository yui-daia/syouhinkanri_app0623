...
export default function ArrivalCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setB_OrderNumber(initialValues.B_OrderNumber);
    setE_Date(initialValues.E_Date);
    setG_SupplierCode(initialValues.G_SupplierCode);
    setH_supplier(initialValues.H_supplier);
    setL_ItemCode(initialValues.L_ItemCode);
    setM_ItemName(initialValues.M_ItemName);
    setR_qaunty(initialValues.R_qaunty);
    setT_unit(initialValues.T_unit);
    setAB_detail1(initialValues.AB_detail1);
    setAC_detail2(initialValues.AC_detail2);
    setErrors({});
  };
  const validations = {
    B_OrderNumber: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Arrival(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ArrivalCreateForm")}
      {...rest}
    >
      <TextField
